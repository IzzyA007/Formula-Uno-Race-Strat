    ...
    <section className = "the-page">
      ...
      <div className = "cards-container">
        ...
        <div className = "row">
          ...
          <div className = "column">
            <div className = "card">
              <img src= {haasSymbol} alt="Haas logo" className="card-img"></img>
              <h3> Haas </h3>
              <ul className = "card-list">
          ...
          <div className = "column">
            <div className = "card">
              <img src= {mclarenSymbol} alt="McLaren logo" className="card-img"></img>
              <h3> McLaren </h3>
              <ul className = "card-list">
                <li>Lando Norris</li>
                <li>Oscar Piastri</li>
        ...
        <div className = "row">
          ...
          <div className = "column">
            <div className = "card">
              <img src= {RBSymbol} alt="RB logo" className="card-img"></img>
              <h3> RB </h3>
              <ul className = "card-list">
                <li>Yuki Tsunoda</li>
          ...
          <div className = "column">
            <div className = "card">
              <img src= {redBullSymbol} alt="Red Bull Racing logo" className="card-img"></img>
          ...
          <div className = "column">
            <div className = "card">
              <img src= {kickSauberSymbol} alt="Kick Sauber logo" className="card-img"></img>
              <h3> Kick Sauber </h3>
              <ul className = "card-list">
          ...
          <div className = "column">
            <div className = "card">
              <img src= {williamsSymbol} alt="Williams logo" className="card-img"></img>
              <h3> Williams </h3>
              <ul className = "card-list">
